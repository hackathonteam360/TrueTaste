...
<p align="center">
  ...
  <img alt="Release" src="https://img.shields.io/badge/APK-v1.1.2-%23FF6B35">
...
- **Android APK** (SDK 21+, ~100 MB): [TrueTaste-preview.apk](https://github.com/hackathonteam360/TrueTaste/releases/tag/v1.1.2) — install, create an account, and explore the full flow.
